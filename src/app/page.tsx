      ...
      <div className="w-full max-w-4xl mx-auto text-center space-y-8">
        ...
        <section className="bg-card p-6 sm:p-8 rounded-lg shadow-lg border-border/50 max-w-2xl mx-auto text-left space-y-4">
          ...
          <p className="font-body text-base sm:text-lg leading-relaxed">
            ...
            power and cling to it like a lifetime freebie scheme. From dramatic
            speeches to magical promises that expire right after elections,
            every trick is exposed with satire.
          </p>
          <p className="font-body text-sm text-muted-foreground italic pt-2">
            <strong>Note:</strong> After payment, you can access the PDF file in
            your Google Drive.
          </p>
        </section>
