    ...
    <div className="min-h-screen w-full relative">
      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 md:p-12 relative z-10">
        <div className="w-full max-w-4xl mx-auto text-center space-y-8">
          <header className="bg-card/50 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-lg border-border/50 space-y-4">
            <Dialog>
          ...
          <section className="bg-card/50 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-lg border-border/50 max-w-2xl mx-auto text-left space-y-4">
