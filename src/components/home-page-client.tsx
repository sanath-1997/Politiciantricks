  ...
  return (
    <div className="min-h-screen w-full bg-background flex flex-col">
      <main className="flex-grow flex flex-col items-center justify-center p-4 sm:p-8 md:p-12">
        <div className="w-full max-w-2xl mx-auto bg-card rounded-xl shadow-2xl overflow-hidden">
      ...
      <footer className="w-full text-center bg-black/80 backdrop-blur-sm py-6 mt-auto">
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center items-center gap-x-4 sm:gap-x-6 gap-y-2">
          ...
          <FooterLink title="Contact Us">
            <p>
              For any questions, support, or feedback, please reach out to us
            ...
            <ScrollArea className="h-72">
              <div className="space-y-4 pr-6">
                ...
                <p>
                  ...
                  outline the rules and regulations for the purchase and use of
                  our ebook. By purchasing, you agree to these terms.
                </p>
            ...
            <ScrollArea className="h-72">
              <div className="space-y-4 pr-6">
                ...
                <p>
                  ...
                  address during the payment process to facilitate the delivery
                  of the ebook.
                </p>
          ...
          <FooterLink title="Refund Policy">
            <p>
              Due to the digital nature of the ebook, all sales are final. We do
              not offer refunds or cancellations once the purchase is complete
              and the product has been delivered. If you experience any issues
              accessing the file, please contact us at{" "}
              <a
                href="mailto:sanathselvakumaran@gmail.com"
                className="text-primary hover:underline"
              >
          ...
          <FooterLink title="Shipping & Delivery">
            <p>
              This is a digital product (ebook in PDF format). Upon successful
              payment, you will be automatically redirected to a Google Drive
              link where you can view and download the ebook. There is no
              physical product to be shipped. You will have instant access after
              your purchase is confirmed.
            </p>
          </FooterLink>
        </div>
        <p className="text-sm mt-6 text-white/80">
          © {isClient ? new Date().getFullYear() : "2024"} PolitiTricks Exposed.
          All Rights Reserved.
        </p>
      </footer>
    </div>
